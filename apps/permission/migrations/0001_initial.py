    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appkey', models.CharField(help_text='APPkey', max_length=64, unique=True, verbose_name='APPkey')),
                ('appname', models.CharField(help_text='APP名称', max_length=32, verbose_name='APP名称')),
